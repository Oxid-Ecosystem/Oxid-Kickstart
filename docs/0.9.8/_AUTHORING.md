# Oxid-DB 0.9.8 docs: authoring contract (read before writing a page)
...
<main class="article">
  ...
  <div class="article-footer">
    ...
    <span>Oxid-DB 0.9.8 · Built with Rust</span>
  </div>
</main>
```
...
- Verify EVERY endpoint path, request body field, response field, OxQL keyword, and SDK method
  name against the actual 0.9.8 code and the reference files in `.build/` before writing it.
